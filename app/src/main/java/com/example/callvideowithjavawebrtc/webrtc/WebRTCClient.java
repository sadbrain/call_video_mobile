...
public class WebRTCClient {
    ...
    public WebRTCClient(Context context, PeerConnection.Observer observer, String username) {
        ...
        iceServer.add(PeerConnection.IceServer.builder("turn:relay1.expressturn.com:3478")
                .setUsername("efO0BSYZM7UR3W96BX")
                .setPassword("05HaAgTYG2dMbaBt").createIceServer());
